      ...
      <article className="cont_app-padre">
        <section className="presentacion">
          <div className="cont_img">
            <img
              src="https://github.com/abram001X/My-Portfolio/blob/main/img/WhatsApp%20Image%202024-08-01%20at%2011.35.33%20PM.jpeg?raw=true"
              alt="Abraham Alfonzo"
              className="yo_img"
            />
        ...
        <section className='cont_about-padre'>
          ...
          <div className='retrato_img'>
            <img src="https://github.com/abram001X/My-Portfolio/blob/main/img/WhatsApp%20Image%202024-08-01%20at%2011.35.07%20PM%20(1).jpeg?raw=true" alt="" className='img-about'/>
          </div>
          </section>
